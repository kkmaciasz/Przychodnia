...
namespace Przychodnia
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Termin termin1 = new Termin(new DateTime(2028, 2, 22), lekarz1, true);
            Termin termin2 = new Termin(new DateTime(2020,1, 23), lekarz1, true);
            Termin termin3 = new Termin(new DateTime(2023, 5, 4), lekarz1, true);
